...
export GITHUB_USER="MileFisher" ## Replace Your GitHub Username or Org Name
  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::302726987033:user/OIDCtest:oidc-provider/token.actions.githubusercontent.com"
      },
